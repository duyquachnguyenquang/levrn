...
const INITIAL_DEMO_SUBJECTS: Subject[] = [
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&w=1000&q=80", // Toán học & Giải tích
    startDate: "2026-09-01",
    totalWeeks: 15,
    endDate: "2026-12-25",
    scheduleDays: [4, 6], // Thứ Năm & Thứ Bảy hàng tuần
    startTime: "07:30",
    endTime: "10:30",
    room: "B.304",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?auto=format&fit=crop&w=1000&q=80", // Ngoại ngữ & Sách vở
    startDate: "2026-09-01",
    totalWeeks: 15,
    endDate: "2026-12-25",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=1000&q=80", // CNTT & Lập trình
    startDate: "2026-09-01",
    totalWeeks: 15,
    endDate: "2026-12-25",
    scheduleDays: [1, 3, 6], // Thứ Hai, Thứ Tư & Thứ Bảy hàng tuần
    startTime: "07:00",
    endTime: "11:30",
    room: "Lab 05",
